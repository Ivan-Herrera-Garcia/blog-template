  ...
  return (
    <main className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8 m-4 transition hover:shadow-2xl">
        <h1 className="text-4xl font-bold mb-4 text-gray-800">Latest Projects</h1>
        <p className="text-gray-700 text-lg mb-6 leading-relaxed">
          Stay updated with the latest projects and articles on programming, anime, games, and more.
        </p>
        ...
        {loading ? (
          ...
          <div className={isGridView ? 'grid md:grid-cols-2 gap-6' : 'space-y-6'}>
            {posts.map((post, index) => (
              ...
              >
                <Link href={`/projects/${post._id}`} className="block mb-2 hover:cursor-pointer">
